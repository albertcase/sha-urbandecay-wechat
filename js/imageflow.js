	...
	this.refresh = function()
	{
		...
		if(my.buttons)
		{
			my.buttonPreviousDiv.onclick = function () { 
				...
				// add by ning
				$('.proRow0,.proRow1').css({'left':275});
				$('#myImageFlow_images img').eq(0).css({'left':504})
				$('.proRow2,.proRow3,.proRow4').css({'left':275});
				$('.proRow5').css({'left':271});
			};
			my.buttonNextDiv.onclick = function () { 
				my.MouseWheel.handle(-1); 
				// add by ning
				$('.proRow1').css({'left':280});
				$('.proRow2,.proRow3,.proRow4').css({'left':280});
				$('.proRow5').css({'left':276});
			};
		}
